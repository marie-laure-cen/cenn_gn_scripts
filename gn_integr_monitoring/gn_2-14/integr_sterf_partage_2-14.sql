...
-----------------------------------------------------------------------------
EXEMPLE DE SCRIPT D'INTEGRATION DE DONNEES DANS UN MODULE DE SUIVI MONITORING
-----------------------------------------------------------------------------

Dans cet exemple, le module a pour code "sterf". Les données à importer sont structurées comme l'exemple suivant :

fid             | 1
transect        | ***_T01
annee           | 2024
num_passage     | 4
visit_date_min  | 2024-09-11 15:10:00
tp              | 21-25°C
cn              | 50-75%
vt              | Modéré
os_1            | Forêts et milieux semi-naturels
os_2            | Pelouses, pâturages naturels
hab_1           | Ca4c
hab_2           | NULL
visit_comment   | Pâturage extensif en cours (3 vaches)
determiner      | ***
cd_nom          | 219831
nom_complet     | Pieris rapae (Linnaeus, 1758)
effectif        | 1
obs_comment     | NULL
geom_local      | ***
...
/* 
------------------------------------
PROCEDURE D'INTEGRATION DE DONNEES
------------------------------------
*/
